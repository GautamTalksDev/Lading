...
Each artifact is extracted to a profile rootfs, scanned with Grype~\cite{grype} 0.115.0, and
...
immediate practical consequence than anything above. It concerns Trivy~\cite{trivy} 0.72.0
reading SBOMs produced by Syft~\cite{syft} 1.51.0, two widely deployed open source tools.
...
Asked for SPDX rather than CycloneDX on the same tar, Syft produces a
document carrying 151 packages with valid PURLs. Trivy retains
