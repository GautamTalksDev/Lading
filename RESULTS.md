...
- **real-011** — **CVE-2026-14456** on **`subst-mosquitto`** / component **`openssl`**: pipeline claimed **`NOT_AFFECTED`** (`vulnerable_code_not_present`); hand-check found **`UNDER_INVESTIGATION`**. FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
...
- **real-010** **CVE-2026-14456** **`oci-python-3.12`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
- **real-011** **CVE-2026-14456** **`subst-mosquitto`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
...
- **real-021** **CVE-2026-14456** **`subst-httpd-alpine`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
...
- **real-043** **CVE-2026-14456** **`oci-postgres-16`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
...
- **real-068** **CVE-2026-14456** **`oci-postgres-16`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
- **real-074** **CVE-2026-14456** **`oci-ruby-3.3`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
...
- **real-088** **CVE-2026-14456** **`oci-memcached-1.6`** (component `openssl`): pipeline **`NOT_AFFECTED`** → hand **`UNDER_INVESTIGATION`** — FINDING-002: D02 on port_default_packet_handler unsound — handler not in libssl.so.3 .dynsym (0 exported) while objdump shows 691 DTLS references, 13 exported DTLS symbols, 43 DTLS strings on oci-redis-7 libssl.so.3. Initial check used libcrypto.so.3 (wrong library). [DTLS wording withdrawn, see FINDING-003; CVE-2026-14456 is QUIC]
