...
| 2026-08-25 | Aqua Security / Trivy | https://github.com/aquasecurity/trivy/discussions/11140 | SPDX ingestion package loss: Syft spdx-json for nginx:1.25 has 151 packages with PURLs; `trivy sbom` retains 1 (`pkg:maven/libintl/libintl@0.21`), 0 vulns. Debug: `Detected OS family="none"` / `Unsupported os` (CycloneDX same tar: `debian 12.5`, `pkg_num=149`). Related but distinct from #11139; prior art #8629, #7100. trivy DB 2026-08-25. | Open (False Detection discussion) |
